Public Class Editor
    ...
    Private Sub CAPTURA_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        MsgBox("Esta Herramienta no esta Disponible", MsgBoxStyle.Critical, "Worcome Security")
        Me.Close()
    ...
    Private Sub ButtonINTRODUCIR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonINTRODUCIR.Click
        ...
        LabelTEXTO.Text = InputBox("ESCRIBE TU TEXTO") 'ENTRADA DEL TEXTO
    End Sub
    ...
    Private Sub ButtonGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonGUARDAR.Click
        SaveFileDialog1.DefaultExt = ".jpg" 'PONDRA AUTOMATICAMENTE LA EXTENSION JPG
        If SaveFileDialog1.ShowDialog Then
            Threading.Thread.Sleep(1000) 'PARA DAR TIEMPO A QUE DESAPAREZCA EL DIALOGO
